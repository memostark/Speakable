...
Speakable includes a text viewer that allows you to use all the app features (such as TTS, text translation and definition) in easier way.
...
<img src="readme_images/text-viewer-gif.gif" alt="drawing" width="350"/>
